...
<html>
    ...
    <body>
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                    <h1>Lets's grab some great Dealz..!!</h1>
                    <p>We have the best Collection for you. No need to hunt around, we have all in one place.</p>
                </div>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/black-round-sunglasses-on-top-left-of-blue-background.jpg" alt="Sunglass">
                            </a>
                            <center>
                                <div class="caption">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/reflective-sunglasses.jpg" alt="R-Sunglass">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>R-Sunglass</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/black-round-sunglasses-on-top-right-of-yellow-background.jpg" alt="Sunglass">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Round Sunglass</h3>
                                    <p>Price: Rs. 3699.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                                        }
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/sunglasses-car-keys.jpg" alt="Sunglass">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Matte Sunglass</h3>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/pocket-watch-on-black.jpg" alt="Watch">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Pocket Watch</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/modern-bamboo-wristwatch.jpg" alt="Bamboo">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Bamboo Watch #201</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/white-faced-watch.jpg" alt="Watch">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>PeterEngland-148</h3>
                                    <p>Price: Rs. 8000.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/white-clock.jpg" alt="Watch">
                            </a>
                            <center>
                                <div class="caption">
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/smiling-woman-poses.jpg" alt="Casual">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Casual</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/modern-bride-in-beaded-bodice.jpg" alt="Bride">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Bride Dress</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/man-in-suit-on-stairs.jpg" alt="Bridegroom">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>BrideGroom</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/tie-clip.jpg" alt="Tie">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Tie-Clip</h3>
